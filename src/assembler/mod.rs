...
enum TokenSource<R, A: ArchTokens> {
    /// Normal lexer
    Lexer(Lexer<R, A>),
    /// Lexer generated by the `@parse` directive
            ...
            match self.stash {
                ...
                None => match &mut self.token_source {
                    ...
                    Some(token_source) => {
                        ...
                        // Note: we intentionally do not skip all newlines and comments.
                        ...
                        {
                            match token_source.next(&mut self.macros).transpose()? {
                                ...
                                Some(tok) => {
                                    return asm_err!(
                                        tok.loc(),
                                        "Unexpected {}, expected a line break or comment after a backslash",
    ...
    fn expect_each_directive(
        ...
        loop {
            match self.next()? {
                ...
                {
                    toks.push(MacroToken::Argument { index: 0 });
                }
                ...
                Some(tok @ Token::Directive { loc, name }) => {
                    match name {
                        ...
                        DirectiveName::Macro => {
                            ...
                            self.macros.insert(value, Macro { args, tokens: toks });
                        }
